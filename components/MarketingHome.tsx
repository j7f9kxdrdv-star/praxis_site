 ...
 *
 * Pure UI — no auth gating, no launch-mode awareness, no auth-aware CTA
 * swapping. Buttons are labeled and routed exactly as they will appear to
 * visitors at launch ("Sign In" -> /login, "Create an Account" -> /signup).
 *
 * Pre-launch consequence: while the founder is logged in and previewing
 * this page, clicking the marketing CTAs goes through /login or /signup
 * (which short-circuits authed users back to / or redirects in preview).
 * That's intentional — the founder uses /dashboard directly to access the
 * app and doesn't depend on these buttons.
 */
