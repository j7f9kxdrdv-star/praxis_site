...
BEGIN
    ...
    (deck, 10, 'cloze',
     ...
     2),
    (deck, 11, 'cloze',
     'Hormone-sensitive lipase (HSL) is activated by falling {{c1::insulin}} levels and by stress hormones {{c1::epinephrine}} and {{c1::cortisol}} — all signals that the body needs to burn stored fat.',
     1),
    (deck, 12, 'cloze',
    ...
    (deck, 39, 'cloze',
     ...
     3),
    (deck, 40, 'cloze',
     'Acetyl-CoA carboxylase (ACC) is activated by {{c1::insulin}} and {{c1::citrate}} (signals of abundant energy and acetyl-CoA), and inhibited by palmitoyl-CoA (the end-product feedback signal).',
     1),
    (deck, 41, 'cloze',
