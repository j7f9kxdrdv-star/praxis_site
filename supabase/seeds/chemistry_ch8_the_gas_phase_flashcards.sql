...
BEGIN
    ...
    (deck, 2, 'cloze',
     ...
     2),
    (deck, 3, 'cloze',
     'A mercury {{c1::barometer}} measures {{c1::atmospheric}} pressure by the height of the mercury column it supports.',
     1),
    (deck, 4, 'cloze',
    ...
    (deck, 26, 'cloze',
     ...
     1),
    (deck, 27, 'cloze',
     'For a mixture of ideal gases, the total pressure is P_total = {{c1::P₁ + P₂ + P₃ + …}}',
     1),
    (deck, 28, 'cloze',
     ...
     1),
    (deck, 29, 'cloze',
     'The partial pressure of component i in a gas mixture is Pᵢ = {{c1::χᵢ × P_total}}.',
     1),
    (deck, 30, 'cloze',
     'The mole fraction of component i is χᵢ = {{c1::nᵢ / n_total}}.',
     1),
    (deck, 31, 'cloze',
    ...
    (deck, 37, 'cloze',
     ...
     1),
    (deck, 38, 'cloze',
     'The average kinetic energy of a single gas molecule is KE_avg = {{c1::(3/2)k_B T}}, set only by the absolute temperature.',
     1),
    (deck, 39, 'cloze',
     'Boltzmann''s constant, k_B, equals the ideal gas constant R divided by {{c1::Avogadro''s number}}.',
     1),
    (deck, 40, 'cloze',
     'The root-mean-square speed of gas molecules is u_rms = {{c1::√(3RT/M)}}, where M is the molar mass in kg/mol.',
     1),
    (deck, 41, 'cloze',
