...
BEGIN
  ...
  (deck, 12, 'cloze',
   'A {{c1::first}}-order reaction obeys rate = k[A], so doubling [A] {{c2::doubles}} the rate; the integrated law is [A]ₜ = [A]₀ · exp(−kt), a plot of {{c3::ln[A]}} versus t is linear with slope −k, and k has units of {{c4::s⁻¹}}.', 4),
  (deck, 13, 'cloze',
  ...
  (deck, 23, 'cloze',
   'The Arrhenius equation, k = {{c1::A · exp(−Eₐ/RT)}}, ties a reaction''s rate constant to its {{c2::activation energy}} and to {{c3::temperature}}.', 3),
  (deck, 24, 'cloze',
   'In the Arrhenius equation the exponential factor is {{c1::exp(−Eₐ/RT)}}, where R = {{c2::8.314 J·mol⁻¹·K⁻¹}} and T is in {{c3::kelvin}}.', 3),
  (deck, 25, 'cloze',
  ...
  (deck, 26, 'cloze',
   'Because Eₐ sits in the exponent as exp(−Eₐ/RT), a {{c1::lower}} activation energy leaves a {{c2::larger}} fraction of molecules with enough energy to react, giving a faster rate.', 2),
  (deck, 27, 'cloze',
