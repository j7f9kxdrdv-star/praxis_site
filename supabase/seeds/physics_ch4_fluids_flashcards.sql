...
BEGIN
    ...
    (deck, 19, 'cloze',
     ...
     1),
    (deck, 20, 'cloze',
     'The buoyant force is Fb = {{c1::ρfluid·Vdisp·g}}, where ρfluid is the fluid''s density, Vdisp is the volume of fluid displaced, and g is the gravitational acceleration.',
     1),
    (deck, 21, 'cloze',
