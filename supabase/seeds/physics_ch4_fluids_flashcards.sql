...
BEGIN
    ...
    (deck, 3, 'cloze',
     ...
     1),
    (deck, 4, 'cloze',
     'A volume V of fluid with density ρ has weight F_g = {{c1::ρVg}}, where g is the gravitational acceleration.',
     1),
    (deck, 5, 'cloze',
    ...
    (deck, 19, 'cloze',
     ...
     1),
    (deck, 20, 'cloze',
     'The buoyant force is F_b = {{c1::ρ_fluid·V_disp·g}}, where ρ_fluid is the fluid''s density, V_disp is the volume of fluid displaced, and g is the gravitational acceleration.',
     1),
    (deck, 21, 'cloze',
