...
BEGIN
    ...
    (deck, 22, 'cloze',
     ...
     2),
    (deck, 23, 'cloze',
     'Written in symbols, Kirchhoff''s junction rule is {{c1::ΣIin = ΣIout}}.',
     1),
    (deck, 24, 'cloze',
     ...
     2),
    (deck, 25, 'cloze',
     'For resistors in series, the equivalent resistance is {{c1::Req = R₁ + R₂ + R₃ + …}}.',
     1),
    (deck, 26, 'cloze',
     'In a series circuit, every resistor carries the same {{c1::current}}, because the charge follows one unbranched path.',
     1),
    (deck, 27, 'cloze',
     'For resistors in parallel, the equivalent resistance comes from {{c1::1/Req = 1/R₁ + 1/R₂ + …}}.',
     1),
    (deck, 28, 'cloze',
    ...
    (deck, 35, 'cloze',
     ...
     1),
    (deck, 36, 'cloze',
     'Capacitors in series combine as {{c1::1/Ceq = 1/C₁ + 1/C₂ + …}}.',
     1),
    (deck, 37, 'cloze',
     'Capacitors in parallel combine as {{c1::Ceq = C₁ + C₂ + …}}.',
     1),
    (deck, 38, 'cloze',
