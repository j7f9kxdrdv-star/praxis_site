...
BEGIN
    ...
    (deck, 0, 'cloze',
        ...
        4),
    (deck, 1, 'cloze',
        'The {{c1::threshold frequency (fT)}} is the minimum incident-light frequency needed to {{c2::eject an electron}} from a given metal; it depends on the metal''s {{c3::work function}}.',
        3),
    (deck, 2, 'cloze',
    ...
    (deck, 5, 'cloze',
        ...
        3),
    (deck, 6, 'cloze',
        'The work function relates to the threshold frequency by {{c1::W = h · fT}} (Planck''s constant times the threshold frequency).',
        1),
    (deck, 7, 'cloze',
        'The maximum kinetic energy of an ejected electron is {{c1::Kmax = hf − W}} — the photon''s energy minus the energy spent {{c2::escaping the metal}}.',
        2),
    (deck, 8, 'cloze',
    ...
    INSERT INTO flashcards (deck_id, position, card_type, cloze_text, cloze_count) VALUES
    (deck, 21, 'cloze',
        'In isotopic (nuclide) notation, an element symbol carries its {{c1::mass number (A)}} as a superscript on the upper left and its {{c1::atomic number (Z)}} as a subscript on the lower left.',
        1),
    (deck, 22, 'cloze',
