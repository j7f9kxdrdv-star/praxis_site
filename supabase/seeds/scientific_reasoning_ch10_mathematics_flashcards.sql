...
BEGIN
    ...
    (deck, 0, 'cloze',
        '{{c1::Scientific notation}} writes a number as a {{c2::significand × 10^exponent}} (e.g., 6.02 × 10²³); it makes very large or very small numbers easy to read and to operate on.',
        2),
    (deck, 1, 'cloze',
    ...
    (deck, 7, 'cloze',
        ...
        1),
    (deck, 8, 'cloze',
        'Multiplying powers with the same base: {{c1::add}} the exponents — X^A · X^B = {{c2::X^(A+B)}}.',
        2),
    (deck, 9, 'cloze',
        'Dividing powers with the same base: {{c1::subtract}} the exponents — X^A / X^B = {{c2::X^(A−B)}}.',
        2),
    (deck, 10, 'cloze',
        'A power raised to a power: {{c1::multiply}} the exponents — (X^A)^B = {{c2::X^(A·B)}}.',
        2),
    (deck, 11, 'cloze',
        'When a fraction is raised to an exponent, the exponent is {{c1::distributed to both numerator and denominator}} — (X/Y)^A = X^A / Y^A.',
        1),
    (deck, 12, 'cloze',
        'A {{c1::negative exponent}} represents the {{c2::reciprocal}}: X^(−A) = {{c3::1 / X^A}}.',
        3),
    (deck, 13, 'cloze',
        'A {{c1::fractional exponent}} A/B means the {{c2::B-th root}} of X^A: X^(A/B) = ᴮ√(X^A).',
        2),
    (deck, 14, 'cloze',
    ...
    (deck, 16, 'cloze',
        ...
        2),
    (deck, 17, 'cloze',
        'Log of a {{c1::power}}: log(A^B) = {{c2::B · log A}}; log of a {{c1::reciprocal}}: log(1 / A) = {{c2::−log A}}.',
        2),
    (deck, 18, 'cloze',
